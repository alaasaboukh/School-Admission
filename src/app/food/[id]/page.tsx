                ...
                <div className="flex items-center gap-10 my-10 flex-wrap">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            <Star className="text-orange-300 w-4 h-4" fill="orange" />
                    ...
                    <div className="flex items-center gap-2">
                        <BarChart2 className="text-[var(--color-primary)] w-16 h-16" />
                        <div>
                            <span className="text-[var(--color-accent2)] font-bold">
                    ...
                    <div className="flex items-center gap-4">
                        <TrendingUp className="text-[var(--color-primary)] w-15 h-15" />
                        <div>
                            <span className="text-[var(--color-accent2)] font-bold">
                                {food.interest}%
                            </span>
                    ...
                    <div className="relative w-14 h-14">
                        ...
                        />
                        <div className="absolute inset-0 flex items-center justify-center text-sm text-[var(--color-accent1)]">
                            {food.percent}%
                        </div>
                    </div>
                </div>
                <div className="flex items-start space-x-15 max-md:space-x-5 max-[450px]:flex-col max-md:space-y-5">
                    <div className="">
