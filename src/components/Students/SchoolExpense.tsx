...
const SchoolExpense = () => {
    ...
    const { students: allStudents, loading } = useAppSelector(
                ...
                {loading ? (
                    ...
                    <>
                        {currentStudent.slice(0, 10).map((student) => (
                            <div
                                className="grid grid-cols-1 sm:grid-cols-[2.5fr_1.5fr_0.5fr] max-md:shadow-md p-3 max-md:rounded-lg gap-3 items-center mt-6"
                                key={student.id}
                            >
