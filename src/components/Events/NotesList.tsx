...
import { CalendarEvent, DeleteEvent } from "@/redux/calendarSlice";
    ...
    return (
        <div className="flex-1 max-lg:w-full">
            <div className="bg-[var(--bg-background)] p-6 rounded-lg mb-4">
                ...
                <p className="text-[var(--color-accent1)] text-xs">{formatted}</p>
            </div>
            {events.length === 0 ? (
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="text-[var(--color-accent2)] hover:bg-red-500 hover:text-white transition-all duration-500 bg-[var(--color-secondary)] p-2 rounded-full cursor-pointer"
                            >
                                <Trash2 size={19} />
                            </button>
                        </div>
