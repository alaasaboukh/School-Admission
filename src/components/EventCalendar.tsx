...
export default function EventCalendar() {
  ...
  while (day <= endDate) {
    ...
    rows.push(
      <div key={day.toString()} className="grid grid-cols-7 gap-3 max-md:gap-8">
        {days}
      </div>
    );
    days = [];
  ...
  return (
    <div className="flex max-lg:flex-col gap-7 items-start">
      {/* التقويم */}
      <div className="bg-[var(--bg-background)] shadow p-6 rounded-lg flex-3 max-lg:w-full">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1 hover:bg-[var(--color-secondary)] text-[var(--color-accent2)] rounded-full transition-all duration-500 cursor-pointer"
            >
        ...
        {/* الأيام */}
        <div className="flex flex-col gap-3 text-[var(--color-accent1)] max-md:pr-5">
          {rows}
        </div>
      </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-[var(--color-accent2)] hover:bg-red-500 hover:text-white transition-all duration-500 cursor-pointer bg-[var(--color-secondary)] p-2 rounded-full"
                  >
                    <Trash2 size={19} />
                  </button>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[var(--bg-background)] rounded-lg p-6 min-w-[400px] relative">
                ...
                {[
                  ...
                  <div
                    ...
                    className={clsx(
                      ...
                      color === clr ? "border--[var(--color-secondary)]" : "border-transparent"
                    )}
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                onClick={saveNote}
                className="px-8 bg-[var(--color-secondary)] hover:bg-[var(--color-primary)] text-white py-2 rounded transition-all duration-500 cursor-pointer"
              >
                Save
              </button>
            </div>
