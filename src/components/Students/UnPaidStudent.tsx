...
const UnPaidStudent = () => {
    ...
    return (
        <div className="bg-[var(--bg-background)] mt-6 rounded-lg p-5 min-h-[670px]">
                ...
                <>
                    {currentStudent.map((student) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                <span className="p-2 bg-[var(--color-orange)] rounded-full text-white">
                                    <User2 size={22} />
                                </span>
                                <div className="flex flex-col ">
                                    ...
                                    <span className="text-sm text-[var(--color-accent2)] font-bold tracking-wide">
                                        {student.class}
                                    </span>
                                </div>
                            </div>
