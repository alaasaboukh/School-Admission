...
const LoginPage = () => {
    ...
    return (
        <div className=" relative w-full ">
            <div className="w-full max-w-md bg-[var(--bg-background)] p-5 rounded-xl shadow-lg absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-1/2">
                ...
                <div>
                    <button
                        ...
                        className="w-full mt-4 text-sm bg-[var(--color-primary)] hover:bg-[var(--color-hover)] text-white py-2 rounded-lg transition-all duration-500 cursor-pointer"
                    >
                        Login with Google
                    </button>
                </div>
