    ...
    return (
        <div className="bg-[var(--color-secondary)] p-4 sm:p-6 w-full min-h-screen">
            ...
            <div className="bg-[var(--color-primary)] relative px-4 sm:px-7 py-10 sm:py-12 rounded-t-lg">
                ...
                <div className="border-4 border-[var(--color-accent4)] w-20 h-20 sm:w-30 sm:h-30 rounded-full absolute top-8 left-5 sm:left-7 z-50 bg-[var(--color-secondary)] overflow-hidden">
                    {teacher.imageUrl && (
                        <Image
            ...
            <div className="bg-[var(--bg-background)] p-5 sm:p-7 rounded-b-lg relative z-40">
                ...
                <div className="mb-7">
                    <h3 className="text-[var(--color-accent2)] font-bold mb-2">
                        Education:
                    </h3>
                    <p className="text-sm text-[var(--color-accent2)]">
                        {teacher.education}
                    </p>
                </div>
                <div>
