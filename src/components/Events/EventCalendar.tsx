...
import { CalendarEvent, loadEventsFromStorage } from "@/redux/calendarSlice";
...
export default function EventCalendar() {
        ...
        <div
          ...
          className={clsx(
            ...
            !isSameMonth(day, monthStart) &&
              "border-[var(--color-accent1)] bg-[var(--color-secondary)]"
          )}
        >
  ...
  return (
    <div className="flex max-lg:flex-col gap-7 items-start ">
      <div className="bg-[var(--bg-background)] p-6 rounded-lg flex-3 max-lg:w-full overflow-x-auto">
