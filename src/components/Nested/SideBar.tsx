...
const navItems = [
    ...
    { id: 2, label: "Students", icon: <Users />, path: "/students" },
    { id: 3, label: "Teachers", icon: <UserRound />, path: "/teatchers" },
    { id: 4, label: "Event", icon: <Calendar />, path: "/event" },
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <Link
                                        href={item.path}
                                        className="flex items-center cursor-pointer outline-none transform hover:scale-110 transition-all duration-500"
                                    >
                        ...
                        {currentUser ? (
                            ...
                            >
                                <span className="flex items-center cursor-pointer outline-none">
                                    <span className="w-8 h-8 mr-3 mt-1">
                                        <LogOut />
                                    </span>
